...
<div class="card border-0 shadow mb-5">
	<div class="card-header bg-gray-100 py-4 border-0">
		<div class="media align-items-center">
            ...
            <button type="button" class="btn btn-secondary mb-2" data-toggle="modal" data-target="#{{ $modal_guid }}" wire:click="create()">
		...
		<table class="table text-sm">
            ...
            <tr>
                ...
                @else
                    @foreach($orari as $v)
                        <td class="pr-0 text-left border-0" style="padding-left: 0px;">
                        <button wire:click="edit({{ $v->id }})" data-toggle="modal" data-target="#{{ $modal_guid }}">
                        @if($v->is_closed)
                        ...
                        @livewire('cart::opening_hours.item',['model'=>$v])
                        --}}
                        </td>
                    @endforeach
                @endif
